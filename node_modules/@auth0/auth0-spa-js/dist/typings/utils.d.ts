...
export declare const fetchWithTimeout: (url: string, audience: string, scope: string, options: {
    [index: string]: any;
}, worker: Worker, timeout?: number) => Promise<unknown>;
export declare const oauthToken: ({ baseUrl, timeout, audience, scope, ...options }: TokenEndpointOptions, worker: Worker) => Promise<any>;
