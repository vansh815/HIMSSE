  ...
  combineLatest(renderProp$, groupRenderProp$, scrollSeekConfiguration$, computeItemKey$, itemContainer$, groupContainer$, dataKey$).pipe(map(function (_ref7) {
    ...
    return {
      render: function render(item, _ref8) {
        ...
        if (item.type === 'group') {
          return createElement(GroupContainer, _extends({
            key: key
          ...
          if (scrollSeek && renderPlaceholder) {
            children = createElement(scrollSeek.placeholder, {
          ...
          return createElement(ItemContainer, _extends({}, itemProps, {
            key: key
          }), children);
        }
      }
...
var VirtuosoList = /*#__PURE__*/memo(function (_ref) {
  ...
  return createElement(Fragment, null, renderedItems);
});
...
var VirtuosoHeader = function VirtuosoHeader(_ref4) {
  ...
  return createElement(HeaderContainer, {
...
var VirtuosoFooter = function VirtuosoFooter(_ref5) {
  ...
  return createElement(FooterContainer, {
...
var ListWrapper = function ListWrapper(_ref6) {
  ...
  return createElement(ListContainer, {
...
var VirtuosoView = function VirtuosoView(_ref7) {
  ...
  return createElement(VirtuosoScroller, {
    style: style,
  ...
  }, header && createElement(VirtuosoHeader, {
    header: header,
    HeaderContainer: HeaderContainer
  }), createElement(VirtuosoList, {
    emptyComponent: emptyComponent
  }), footer && createElement(VirtuosoFooter, {
    footer: footer,
    FooterContainer: FooterContainer
  }))), createElement(VirtuosoFiller, {
    height: fillerHeight
  }));
};

var DEFAULT_STYLE = {};
var VirtuosoPresentation = /*#__PURE__*/memo(function (_ref) {
  ...
  return createElement(VirtuosoContext.Provider, {
    value: contextValue
  }, createElement(VirtuosoView, {
...
var Virtuoso = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return createElement(VirtuosoPresentation, {
    contextValue: state,
    style: props.style,
  ...
  combineLatest(itemRange$, isSeeking$, scrollSeekConfiguration$, gridDimensions$).pipe(map(function (_ref5) {
    ...
    var render = function render(item, itemClassName, ItemContainer, computeItemKey) {
      ...
      for (var index = startIndex; index <= endIndex; index++) {
        ...
        items.push(createElement(ItemContainer, {
          key: key,
...
var VirtuosoGrid = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    return createElement(VirtuosoGridFC, Object.assign({}, this.props, {
      engine: this.state
    }));
  };
