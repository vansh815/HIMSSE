...
var VirtuosoList = /*#__PURE__*/React.memo(function (_ref) {
  ...
  if (renderedItems.length === 0 && emptyComponent) return React.createElement(emptyComponent);
...
var VirtuosoHeader = function VirtuosoHeader(_ref4) {
  ...
  var headerCallbackRef = useHeight(React.useContext(VirtuosoContext).headerHeight);
...
var VirtuosoView = function VirtuosoView(_ref7) {
  ...
  }, header && React.createElement(VirtuosoHeader, {
    header: header,
    HeaderContainer: HeaderContainer
  }), React.createElement(VirtuosoList, {
    emptyComponent: emptyComponent
  }), footer && React.createElement(VirtuosoFooter, {
    footer: footer,
