...
export declare const GroupedVirtuoso: React.ForwardRefExoticComponent<Pick<VirtuosoProps, "overscan" | "header" | "footer" | "computeItemKey" | "prependItemCount" | "itemHeight" | "defaultItemHeight" | "startReached" | "endReached" | "scrollingStateChange" | "atBottomStateChange" | "itemsRendered" | "rangeChanged" | "totalListHeightChanged" | "style" | "dataKey" | "className" | "initialItemCount" | "initialTopMostItemIndex" | "followOutput" | "ScrollContainer" | "HeaderContainer" | "FooterContainer" | "ListContainer" | "ItemContainer" | "maxHeightCacheSize" | "scrollSeek" | "emptyComponent"> & {
    groupCounts: number[];
