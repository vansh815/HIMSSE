...
var Item = /*#__PURE__*/function (_React$Component) {
  _inherits__default['default'](Item, _React$Component);
  ...
  function Item() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "selectItem", function () {
...
var List = /*#__PURE__*/function (_React$Component) {
  _inherits__default['default'](List, _React$Component);
  ...
  function List() {
    ...
    _classCallCheck__default['default'](this, List);
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "cachedValues", null);

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "onPressEnter", function (e) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "getPositionInList", function () {
      var values = _this.props.values;
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "getId", function (item) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "listeners", []);

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "itemsRef", {});

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "modifyText", function (value) {
      if (!value) return;
      var _this$props = _this.props,
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "selectItem", function (item) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "scroll", function (e) {
      if (e && e.preventDefault) {
        e.preventDefault();
      }
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "isSelected", function (item) {
      var selectedItem = _this.state.selectedItem;
      if (!selectedItem) return false;
      return _this.getId(selectedItem) === _this.getId(item);
    });

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "renderHeader", function (value) {
      if (value[0] === '/') {
  ...
  _createClass__default['default'](List, [{
...
var ReactTextareaAutocomplete = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass__default['default'](ReactTextareaAutocomplete, [{
    ...
    value: function render() {
      ...
      }, (dataLoading || suggestionData) && currentTrigger && /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      }, suggestionData && component && textToReplace && /*#__PURE__*/React__default['default'].createElement(List, {
        value: value,
      ...
      })), /*#__PURE__*/React__default['default'].createElement(Textarea__default['default'], _extends__default['default']({}, this._cleanUpProps(), {
...
var LoadingErrorIndicatorComponent = /*#__PURE__*/React__default['default'].memo(LoadingErrorIndicator);
...
var SendButtonComponent = /*#__PURE__*/React__default['default'].memo(SendButton);
...
var MessageInputLarge = function MessageInputLarge(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    d: "M11.108 8.05a.496.496 0 0 1 .212.667C10.581 10.147 8.886 11 7 11c-1.933 0-3.673-.882-4.33-2.302a.497.497 0 0 1 .9-.417C4.068 9.357 5.446 10 7 10c1.519 0 2.869-.633 3.44-1.738a.495.495 0 0 1 .668-.212zm.792-1.826a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.298 0-.431.168-.54.307A.534.534 0 0 1 9.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zm-7 0a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.299 0-.432.168-.54.307A.533.533 0 0 1 2.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zM7 0a7 7 0 1 1 0 14A7 7 0 0 1 7 0zm4.243 11.243A5.96 5.96 0 0 0 13 7a5.96 5.96 0 0 0-1.757-4.243A5.96 5.96 0 0 0 7 1a5.96 5.96 0 0 0-4.243 1.757A5.96 5.96 0 0 0 1 7a5.96 5.96 0 0 0 1.757 4.243A5.96 5.96 0 0 0 7 13a5.96 5.96 0 0 0 4.243-1.757z",
    fillRule: "evenodd"
  })))), messageInput.isUploadEnabled && /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    fillRule: "nonzero"
  })))))), SendButton && /*#__PURE__*/React__default['default'].createElement(SendButton, {
...
MessageInputLarge.propTypes = {
   ...
   * */
  // @ts-ignore
  SendButton: PropTypes__default['default'].elementType
};
...
var useActionHandler = function useActionHandler(message) {
  ...
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee(name, value, event) {
...
var MessageActionsBox = function MessageActionsBox(_ref) {
  ...
  }, messageActions.indexOf(MESSAGE_ACTIONS.flag) > -1 && /*#__PURE__*/React__default['default'].createElement("button", {
    onClick: handleFlag
  }, /*#__PURE__*/React__default['default'].createElement("li", {
...
var MessageActionsWrapper = function MessageActionsWrapper(props) {
  ...
  if (inline) {
    return /*#__PURE__*/React__default['default'].createElement("span", wrapperProps, children);
  }
...
var MessageTextComponent = function MessageTextComponent(props) {
  ...
  var messageTextItem = message === null || message === void 0 ? void 0 : message.text;
  ...
  var messageText = React.useMemo(function () {
    return renderText(messageTextItem, messageMentionedUsersItem);
...
var Message = function Message(props) {
  ...
  }, [channelConfig, message, messageActions, canDelete, canEdit, canReply, canReact, _isMyMessage]);
...
Message.propTypes = {
  ...
  PropTypes__default['default'].objectOf(checkClientPropType).isRequired,
...
var MessageTeam = function MessageTeam(props) {
  ...
  }) : messageText), message && message.text === '' && /*#__PURE__*/React__default['default'].createElement(MessageTeamAttachments, {
...
var FixedHeightMessage = function FixedHeightMessage(_ref) {
  var _message$user, _message$attachments, _message$user2, _message$user3, _message$user4, _message$user5;
  ...
  }, renderedText, /*#__PURE__*/React__default['default'].createElement("div", {
...
var ChannelInner = function ChannelInner(_ref2) {
  ...
  var _ref2$LoadingIndicato = _ref2.LoadingIndicator,
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["LoadingIndicator", "LoadingErrorIndicator", "Attachment", "Message", "doMarkReadRequest"]);
...
var insertDates = function insertDates(messages, lastRead, userID) {
  var unread = false;
  var newMessages = [];
  ...
  for (var i = 0, l = messages.length; i < l; i += 1) {
    ...
    if (!unread) {
      unread = lastRead && lastRead.getTime() < message.created_at.getTime(); // userId check makes sure New is not shown for current user messages

      if (unread && message.user.id !== userID) newMessages.push({
        type: 'message.date',
    ...
    if ((i === 0 || messageDate !== prevMessageDate) && (newMessages === null || newMessages === void 0 ? void 0 : (_newMessages = newMessages[newMessages.length - 1]) === null || _newMessages === void 0 ? void 0 : _newMessages.type) !== 'message.date' // prevent two subsequent DateSeparator
    ) {
        newMessages.push({
          type: 'message.date',
          date: message.created_at
...
var MessageListInner = function MessageListInner(props) {
  var TypingIndicator = props.TypingIndicator,
  ...
  var enrichedMessages = React.useMemo(function () {
    var messageWithDates = insertDates(messages, lastRead, client.userID);
  ...
  }, elements), !threadList && /*#__PURE__*/React__default['default'].createElement(TypingIndicator, null), /*#__PURE__*/React__default['default'].createElement("div", {
    key: "bottom",
    ref: bottomRef
  }));
};
...
var TypingIndicator = function TypingIndicator(_ref) {
  ...
  if (!typing || !client || (channel === null || channel === void 0 ? void 0 : (_channel$getConfig = channel.getConfig()) === null || _channel$getConfig === void 0 ? void 0 : _channel$getConfig.typing_events) === false) return null;
  var users = Object.values(typing).filter(function (_ref2) {
    var _client$user;
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: "str-chat__typing-indicator ".concat(users.length ? 'str-chat__typing-indicator--typing' : '')
  }, /*#__PURE__*/React__default['default'].createElement("div", {
...
var Thread$7 = /*#__PURE__*/function (_PureComponent) {
  _inherits__default['default'](Thread, _PureComponent);
...
_defineProperty__default['default'](Thread$7, "propTypes", {
  ...
  thread:
  /** @type {PropTypes.Validator<ReturnType<import('../types').StreamChatChannelState['messageToImmutable']> | null> } */
  PropTypes__default['default'].object,
...
_defineProperty__default['default'](Thread$7, "defaultProps", {
  threadHasMore: true,
  threadLoadingMore: true,
  fullWidth: false,
  autoFocus: true,
...
var ThreadInner = /*#__PURE__*/function (_React$PureComponent) {
  _inherits__default['default'](ThreadInner, _React$PureComponent);
  ...
  function ThreadInner(props) {
    ...
    _classCallCheck__default['default'](this, ThreadInner);
  ...
  _createClass__default['default'](ThreadInner, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this$props2 = this.props,
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      var _this$props3 = this.props,
          ...
          threadMessages = _this$props3.threadMessages,
          loadMoreThread = _this$props3.loadMoreThread;
      var parentID = thread === null || thread === void 0 ? void 0 : thread.id;

      if (parentID && thread !== null && thread !== void 0 && thread.reply_count && thread.reply_count > 0 && (threadMessages === null || threadMessages === void 0 ? void 0 : threadMessages.length) === 0 && loadMoreThread) {
        loadMoreThread();
      } // If we have a snapshot value, we've just added new items.
      // Adjust scroll so these new items don't push the old ones out of view.
      // (snapshot here is the value returned from getSnapshotBeforeUpdate)
    ...
    value: function render() {
      var _this$props4 = this.props,
          t = _this$props4.t,
          closeThread = _this$props4.closeThread,
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      }, /*#__PURE__*/React__default['default'].createElement("strong", null, t && t('Thread')), /*#__PURE__*/React__default['default'].createElement("small", null, ' ', t && t('{{ replyCount }} replies', {
        ...
        ref: this.messageList
      }, /*#__PURE__*/React__default['default'].createElement(Message$1 // @ts-ignore
      , _extends__default['default']({
        message: thread,
        initialMessage: true,
        threadList: true,
      ...
      }, this.props, this.props.additionalParentMessageProps)), /*#__PURE__*/React__default['default'].createElement("div", {
...
_defineProperty__default['default'](ThreadInner, "propTypes", {
  /** Channel is passed via the Channel Context */
  channel: PropTypes__default['default'].object.isRequired,

  /** the thread (just a message) that we're rendering */
  thread: PropTypes__default['default'].object.isRequired
});
